            ...
            <div className="col-span-1 lg:col-span-9">
              <div className="text-center lg:text-left">
                ...
                <p className="mt-3 text-gray-200">
                  ...
                  {/* {userQuery.data.bio} */}
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque
                  fugit rem voluptas laboriosam officia natus nemoLorem ipsum
                  dolor sit amet consectetur adipisicing elit. Eaque fugit rem
                  voluptas laboriosam officia natus nemo
                </p>
              </div>
