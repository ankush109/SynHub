...
const RightDownbar = () => {
  ...
  return (
    <div className="w-[70%] col-span-1 relative lg:h-[40vh] h-[50vh] my-4 mx-4 border rounded-xl bg-zinc-800 overflow-scroll  scrollbar-hide ">
      <div className="sticky top-0 bg-zinc-900 p-1 m-1    rounded-lg h-10 w-full absolute top ">
      ...
      <ul>
        {userQuery.data?.map((user: any) => {
          return (
            <div className="flex mb-2 justify-between items-center gap-4 pl-6  hover:bg-zinc-900 p-1 px-5 rounded-md group cursor-pointer hover:shadow-lg m-auto">
