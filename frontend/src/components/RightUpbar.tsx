...
const RightUpbar = () => {
  return (
    <div className="w-[100%] mx col-span-1 relative lg:h-[40vh] h-[50vh] my-4 mx-4 border rounded-xl bg-zinc-800 overflow-scroll  scrollbar-hide ">
      <div className="sticky top-0  bg-zinc-900 p-1    rounded-lg h-10 w-full  top ">
        <h1 className=" text-base text-center cursor-pointer font-bold text-gray-100 py-1 w-full ">
          Recent Activity
        </h1>
      </div>
      <ul>
        <div className="flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-zinc-900 p-1 rounded-md group cursor-pointer hover:shadow-lg m-auto">
