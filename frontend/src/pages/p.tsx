        ...
        <div className="relative flex flex-col items-center w-full">
          ...
          <div className="flex flex-col space-y-1 justify-center items-center -mt-12 w-full">
            ...
            <div className="py-2 flex space-x-3">
              <button
                className="flex justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  focus:border-blue-300 rounded max-w-max border bg-transparent border-purple-400 text-purple-400 hover:border-purple-800 hover:border-purple-500 px-4 py-1 flex items-center hover:shadow-lg"
