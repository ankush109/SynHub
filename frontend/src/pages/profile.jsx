...
//                     <div className="flex items-center justify-between mt-6">
//                       <div>
//                         <svg className="w-12 h-12 p-2.5 bg-green-400 bg-opacity-20 rounded-full text-green-600 border border-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
//                       </div>
//                       <div className="flex flex-col">
//                         <div className="flex items-end">
...
//                 </div>
//                 <div className="mt-4">
//                   <canvas id="verticalBarChart" style={{display: 'block', boxSizing: 'border-box', height: '414px', width: '828px'}} width={1656} height={828} />
//                 </div>
//               </div>
//             </div>
//           </div>
